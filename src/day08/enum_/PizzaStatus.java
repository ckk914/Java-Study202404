...
//        public static final String ORDERED = "ORDERED"; //아래랑 같은 의미
//        public static final String READY = "READY"; //아래랑 같은 의미
//        public static final String DELIVERED = "DELIVERED"; //아래랑 같은 의미
